...
public class PieChart extends PieRadarChartBase<PieData> {
    ...
    /**
     * Minimum angle to drawNormalMark slices, this only works if there is enough room for all slices to have
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (valuesToHighlight())
            mRenderer.drawHighlighted(canvas, mChartTouchListener.getLastHighlighted());
    ...
    public boolean needsHighlight(int index) {
        ...
        for (int i = 0; i < mChartTouchListener.getLastHighlighted().size(); i++)
            ...
            if ((int) mIndicesToHighlight.get(i).getX() == index)
                return true;
    ...
    /**
     * set this to true to drawNormalMark the pie center empty
     *
     * @param enabled
     */
    ...
    /**
     * set this to true to drawNormalMark the text that is displayed in the center of the
     * pie chart
     *
     * @param enabled
     */
    ...
    /**
     * Set this to true to drawNormalMark the entry labels into the pie slices (Provided by the getLabel() method of the PieEntry class).
    ...
    /**
     * Sets whether to drawNormalMark slices in a curved fashion, only works if drawing the hole is enabled
     * and if the slices are not drawn under the hole.
     *
     * @param enabled drawNormalMark curved ends of slices
     */
    ...
    /**
     * Returns true if the chart is set to drawNormalMark each end of a pie-slice
     * "rounded".
     *
     * @return
     */
