...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>> extends
    ...
    public void clear() {
        ...
        mChartTouchListener.clearLastHighlighted();
        invalidate();
    }
    ...
    protected void drawDescription(Canvas c) {
        ...
        if (mDescription != null && mDescription.isEnabled()) {
            ...
            // if no position specified, drawNormalMark on default position
            if (position == null) {
     ...
     * chart
     */
    protected ArrayList<Highlight> mIndicesToHighlight = new ArrayList<Highlight>();
     ...
     * @return
     */
    public ArrayList<Highlight> getHighlighted() {
        return mChartTouchListener.getLastHighlighted();
    }
    ...
    public boolean valuesToHighlight() {
        return mChartTouchListener.getLastHighlighted().size() <= 0
                || mChartTouchListener.getLastHighlighted() == null ? false
                : true;
    }
     ...
     * //     * @param highs
     */
//    public void moveNextHighlight() {
//
//        try {
//            Log.d("Highlighted.size", mChartTouchListener.getLastHighlighted().size() + "");
//            if (mChartTouchListener.getLastHighlighted().size() == 0) {
//                Log.d("getLastHighlighted", "if");
//                mChartTouchListener.addLastHighlighted(new Highlight(0,
//                        getData().getDataSetByIndex(0).getEntryForIndex(0).getY(),
//                        0));
//            } else if (mChartTouchListener.getXByIndex(getSelectedHighlightIndex()) + 1 < getData().getEntryCount()) {
//                Log.d("getLastHighlighted", "else if");
//                mChartTouchListener.setLastHighlighted(mChartTouchListener.getSelectedHighlightIndex(), new Highlight(mChartTouchListener.getXByIndex(getSelectedHighlightIndex()) + 1,
//                        getData().getDataSetByIndex(0).getEntryForIndex(mChartTouchListener.getXByIndex(getSelectedHighlightIndex()) + 1).getY(),
//                        0));
//            }
//            invalidate();
//        } catch (Exception e) {
...
//    }
//
//    public void movePrevHighlight() {
//
//        try {
//            if (mChartTouchListener.getLastHighlighted().size() == 0) {
//                mChartTouchListener.addLastHighlighted(new Highlight(getData().getDataSetByIndex(0).getXMax() - 1,
//                        getData().getDataSetByIndex(0).getEntryForIndex((int) (getData().getDataSetByIndex(0).getXMax() - 1)).getY(),
//                        0));
//                syncLastHighlights();
//            } else if (mChartTouchListener.getXByIndex(getSelectedHighlightIndex()) - 1 >= 0)
//                mChartTouchListener.setLastHighlighted(mChartTouchListener.getSelectedHighlightIndex(), new Highlight(mChartTouchListener.getXByIndex(getSelectedHighlightIndex()) - 1,
//                        getData().getDataSetByIndex(0).getEntryForIndex(mChartTouchListener.getXByIndex(getSelectedHighlightIndex()) - 1).getY(),
//                        0));
//
...
//    }
    ...
    public int getSelectedHighlightIndex() {
        return mChartTouchListener.getSelectedHighlightIndex();
    }

    public void setSelectedHighlightIndex(int idx) {
        mChartTouchListener.setSelectedHighlightIndex(idx);
    }

    public Highlight getSelectedHighlight() {
        return getHighlighted().get(getSelectedHighlightIndex());
    }

    public Highlight getDraggingHighlight() {
        return mChartTouchListener.getDraggingHighlight();
    }

    public void clearHighlight() {
        if (mChartTouchListener.getLastHighlighted() == null) return;
        mChartTouchListener.getLastHighlighted().clear();
        mChartTouchListener.setLastHighlighted(new ArrayList<Highlight>());
        mChartTouchListener.setOffSelectHighlight();
        syncLastHighlights();
    }
     ...
     * @param highs
     */
//    public void highlightValues(ArrayList<Highlight> highs) {
//
//        // set the indices to highlight
//        mIndicesToHighlight = highs;
//        mChartTouchListener.setLastHighlighted(highs);
//
//        // redraw the chart
//        invalidate();
//    }
//
//    public void addHighlightValue(Highlight high) {
//
//        if (mIndicesToHighlight == null)
//            mIndicesToHighlight = new ArrayList<>();
//
//        mIndicesToHighlight.add(high);
//        mChartTouchListener.addLastHighlighted(high);
//
//        invalidate();
//    }

    public void addHighlightValue(int idx, Highlight high) {

//        if(mIndicesToHighlight == null)
//            mIndicesToHighlight = new ArrayList<>();
//
//        mIndicesToHighlight.set(idx, high);

        mChartTouchListener.addLastHighlighted(idx, high);
    ...
    public void removeHighlightValue(int idx) {

        if (mChartTouchListener.getLastHighlighted() != null
                && mChartTouchListener.getLastHighlighted() != null
                && mChartTouchListener.getLastHighlighted().size() > idx && idx >= 0) {

            mChartTouchListener.removeHighlightByIndex(idx);
            setMarkerOff();
        }
    ...
    public void removeAllHighlightValue() {
        mChartTouchListener.removeAllHighlights();
        invalidate();
    }

    public boolean isAllOffHighlights() {
        return mChartTouchListener.isAllOffHighlights();
    }

    public boolean checkMarkerInChart() {

        boolean isMarker = false;

        for(int i=0; i< mChartTouchListener.getLastHighlighted().size(); i++) {

            if(mChartTouchListener.getLastHighlighted().get(i) != null) {
    ...
    public void syncLastHighlights() {
//        mIndicesToHighlight = mChartTouchListener.getLastHighlighted();
    }
...
//    }
     ...
     *
     * @param high         - the highlight objectj
    ...
    public void highlightValue(Highlight high, boolean callListener) {
        ...
        if (high == null) {
            ...
            if (e == null) {
                ...
                // set the indices to highlight
                mIndicesToHighlight.add(high);
                mChartTouchListener.getLastHighlighted().add(high);
            }
        }
    ...
    public void highlightValue(Highlight high, int idx, boolean callListener) {
...
//                    Log.d("mIndicator", "Length : " + mIndicesToHighlight.size());
//                    Log.d("idx", "Length : " + idx);

                    if (idx < mChartTouchListener.getLastHighlighted().size())
                        mChartTouchListener.addLastHighlighted(idx, high);
                }
            }
        }
...
//        Log.d("mIndicesToHighlight", "mIndicesToHighlight.length : " + mIndicesToHighlight.size());
        for (int i = 0; i < mChartTouchListener.getLastHighlighted().size(); i++) {

            Highlight highlight = (Highlight) mChartTouchListener.getLastHighlighted().get(i);
            ...
            Entry e = mData.getEntryForHighlight((Highlight) mChartTouchListener.getLastHighlighted().get(i));
            int entryIndex = set.getEntryIndex(e);

            // make sure entry not null
            if (e == null || entryIndex > set.getEntryCount() * mAnimator.getPhaseX()) {
                Log.d(" entryIndex", " entryIndex");
                continue;
            }
            ...
            // drawNormalMark the marker

            mIndicesToHighlight = mChartTouchListener.getLastHighlighted();
            if (mIndicesToHighlight.get(i).getX() >= getXAxis().getAxisMinimum() &&
                    mIndicesToHighlight.get(i).getX() <= getXAxis().getAxisMaximum()) {

//                mMarker.drawNormalMark(canvas, pos[0], pos[1], "M" + (i+1));

                Highlight high = mIndicesToHighlight.get(i);

                // [jigum] 2021-07-14
                // ✓ Normal Marker인 경우, 이름을 ‘M1’ 대신 숫자만 표시. Ex) ‘M1’ -> ‘1’ 로 변경
                // ✓ Delta Marker의 경우 이름을 ‘Marker Index Δ Marker Index’ 로 표시. Ex) ‘M1’ -> ‘1Δ2’
                // ✓ Fixed Mar의 경우 이름만 표시. Ex) ‘M1’ -> ‘1’
                if(high.isDelta()) {
                    //high.setMessage((i+1) + "Δ" + (i+1));
                } else {
                    high.setMessage("" + (i+1));
                }

//                if(high.isFixed()) {
//                    mMarker.drawFixedMark(canvas, pos[0], pos[1], high.getMessage());
//                } if (i == mChartTouchListener.getSelectedHighlightIndex()) {
//                    mMarker.drawSelectMark(canvas, pos[0], pos[1], high.getMessage());
//                } else {
//                    mMarker.drawNormalMark(canvas, pos[0], pos[1], high.getMessage());
//                }
                ...
                if(high.isDelta()) {
                    if(i == mChartTouchListener.getSelectedHighlightIndex())
                        ...
                        mMarker.drawNormalMark(canvas, pos[0], pos[1], high.getMessage());
                } else if(high.isFixed()) {
                    //high.setMessage("M" + (i+1));
                    mMarker.drawFixedMark(canvas, pos[0], pos[1], high.getMessage());
//                    Log.d("Chart", "Fixed");
                }
                else if (i == mChartTouchListener.getSelectedHighlightIndex()) {
                    //high.setMessage("M" + (i+1));
                    mMarker.drawSelectMark(canvas, pos[0], pos[1], high.getMessage());
//                    Log.d("Chart", "Select");
                } else {
...
//                    Log.d("Chart", "Normal");
     ...
     * which to drawNormalMark the chart.
     *
     * @param text
     */
    ...
    /**
     * Set this to true to drawNormalMark a user specified marker when tapping on
    ...
    public Bitmap getChartBitmap() {
        ...
        if (bgDrawable != null)
            // has background drawable, then drawNormalMark it on the canvas
            bgDrawable.draw(canvas);
        else
            // does not have background drawable, then drawNormalMark white background on
            // the canvas
            canvas.drawColor(Color.WHITE);
        // drawNormalMark the view on the canvas
        draw(canvas);
        // return the bitmap
    ...
    public boolean saveToGallery(String fileName, String subFolderPath, String
            fileDescription, CompressFormat
                                         format, int quality) {
        // restrain quality
