...
public interface IMarker {
     ...
     * @param posY
     */
    void drawNormalMark(Canvas canvas, float posX, float posY, String msg);
    void drawSelectMark(Canvas canvas, float posX, float posY, String msg);
    void drawFixedMark(Canvas canvas, float posX, float posY, String msg);
    void drawForContinuous(Canvas canvas, float posX, float posY, String msg);
    void drawSemMark(Canvas canvas, float posX, float posY, String msg);
    void drawRightArrow(Canvas canvas, float posX, float posY, String msg);
