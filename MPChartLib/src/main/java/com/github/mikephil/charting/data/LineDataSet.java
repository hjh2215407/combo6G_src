...
//            intensity = 0.05f;
    ...
    /**
     * Gate Box "start" "stop" 표시
     */
    private boolean drawStartStop = false;

    public boolean isDrawStartStop() {
        return drawStartStop;
    }

    public void setDrawStartStop(boolean drawStartStop) {
        this.drawStartStop = drawStartStop;
    }

    private boolean drawGateSymbol = false;
    private String symbolValue = "";

    public boolean isDrawGateSymbol() {
        return drawGateSymbol;
    }

    public void setDrawGateSymbol(boolean drawGateSymbol) {
        this.drawGateSymbol = drawGateSymbol;
    }
