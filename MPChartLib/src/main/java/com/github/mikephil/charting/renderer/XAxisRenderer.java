...
//        drawLabel(c, (int)mXAxis.mAxisMinimum + "", mViewPortHandler.contentLeft(), pos + 30, anchor, labelRotationAngleDegrees);
//        drawLabel(c, (int)mXAxis.mAxisMaximum + "", mViewPortHandler.contentRight(), pos + 30, anchor, labelRotationAngleDegrees);
//        drawLabel(c, (int)((mXAxis.mAxisMaximum + mXAxis.mAxisMinimum) / 2) + "",
//                (mViewPortHandler.contentLeft() + mViewPortHandler.contentRight()) / 2, pos + 30, anchor, labelRotationAngleDegrees);
