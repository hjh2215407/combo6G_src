...
public class CombinedChart extends BarLineChartBase<CombinedData> implements CombinedDataProvider {
    ...
    /**
     * Returns the currently set drawNormalMark order.
     *
     * @return
     */
    ...
    protected void drawMarkers(Canvas canvas) {
        ...
        for (int i = 0; i < mIndicesToHighlight.size(); i++) {

            Highlight highlight = mIndicesToHighlight.get(i);
            ...
            mMarker.drawNormalMark(canvas, pos[0], pos[1], "");
        }
    }
