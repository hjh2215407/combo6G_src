...
public abstract class DataRenderer extends Renderer {
     ...
     *
     * @param c         canvas
     * @param valueText label to drawNormalMark
     * @param x         position
     * @param y         position
     * @param color
     */
     ...
     */
    public abstract void drawHighlighted(Canvas c, ArrayList<Highlight> indices);

    public abstract void drawSelectedHighlight(Canvas c, Highlight high);
}
