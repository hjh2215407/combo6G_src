...
public class YAxisRenderer extends AxisRenderer {
    ...
    protected void drawYLabels(Canvas c, float fixedPosition, float[] positions, float offset) {
        ...
        for (int i = from; i < to; i++) {
            ...
            c.drawText(text,
                    fixedPosition + xOffset - 15,
                    positions[i * 2 + 1] + offset,
                    mAxisLabelPaint);
        }

//        float left = mYAxis.mAxisMinimum;
//        float center = (mYAxis.mAxisMinimum + mYAxis.mAxisMaximum) / 2f;
//        float right = mYAxis.mAxisMaximum;
//
//        if(isVswr) {
//
//            c.drawText(String.valueOf(Math.round(left * 100) / 100f),
//                    fixedPosition - 15, mViewPortHandler.contentBottom() + offset, mAxisLabelPaint);
//
//            c.drawText(String.valueOf(Math.round(center * 100) / 100f) ,
//                    fixedPosition - 15, (int)((mViewPortHandler.contentBottom() + mViewPortHandler.contentTop()) / 2) + offset, mAxisLabelPaint);
//
//            c.drawText(String.valueOf(Math.round(right * 100) / 100f),
//                    fixedPosition - 15, mViewPortHandler.contentTop() + offset, mAxisLabelPaint);
//
//        } else {
//
//            c.drawText(String.valueOf(Math.round(left * 100) / 100f),
...
//        Log.d("positions[i+1]", positions[i+1] + "");
    ...
    protected void drawZeroLine(Canvas c) {
        ...
        // drawNormalMark a path because lines don't support dashing on lower android versions
