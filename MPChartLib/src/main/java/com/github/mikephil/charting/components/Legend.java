...
public class Legend extends ComponentBase {
    ...
    public enum LegendForm {
        ...
        /**
         * Do not drawNormalMark the a form, but leave space for it
         */
        EMPTY,
    ...
    /**
     * returns whether the legend will drawNormalMark inside the chart or outside
     *
     * @return
     */
    ...
    /**
     * sets whether the legend will drawNormalMark inside the chart or outside
     *
     * @param value
     */
        ...
        switch (mOrientation) {
            ...
            case HORIZONTAL: {
                ...
                for (int i = 0; i < entryCount; i++) {
                    ...
                    //@@ 22.01.06 SEM Exception Fix
                    try {
                        if (e.form == null) {
                            e.form = new  LegendEntry().form;
                        }
                    }
                    catch (NullPointerException except) {
                        Log.e("Null", except.toString());
                    }
                    ...
                    if (label != null) {
                        ...
                        try {
                            ...
                            Log.e("SEM CHART", "Exception Occur : " + exception);
                            Log.e("SEM CHART", "i value : " + i);
                        }
