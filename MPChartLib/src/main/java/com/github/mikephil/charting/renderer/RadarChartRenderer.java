...
public class RadarChartRenderer extends LineRadarRenderer {
    ...
    protected void drawDataSet(Canvas c, IRadarDataSet dataSet, int mostEntries) {
        ...
        if (dataSet.getEntryCount() > mostEntries) {
            // if this is not the largest set, drawNormalMark a line to the center before closing
        ...
        // drawNormalMark the line (only if filled is disabled or alpha is below 255)
    ...
    protected void drawWeb(Canvas c) {
        ...
        // drawNormalMark the web lines that come from the center
