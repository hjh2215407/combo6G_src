...
public class AvgHoldKeypadBindingImpl extends AvgHoldKeypadBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.ivBackspace, 13);
        sViewsWithIds.put(R.id.tvValue0, 14);
        sViewsWithIds.put(R.id.tvEnter, 15);
    }
    // views
    // variables
    // values
    ...
    public AvgHoldKeypadBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 16, sIncludes, sViewsWithIds));
    }
    private AvgHoldKeypadBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
