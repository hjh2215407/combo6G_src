...
public class IntegerInputKeypadBindingImpl extends IntegerInputKeypadBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.ivBackspace, 15);
        sViewsWithIds.put(R.id.tvEnter, 16);
    }
    // views
    // variables
    // values
    ...
    public IntegerInputKeypadBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 17, sIncludes, sViewsWithIds));
    }
    private IntegerInputKeypadBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
