...
public class FreqKeypadBindingImpl extends FreqKeypadBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tvGhz, 4);
        sViewsWithIds.put(R.id.tvMhz, 5);
        sViewsWithIds.put(R.id.tvKhz, 6);
        sViewsWithIds.put(R.id.tvHz, 7);
        sViewsWithIds.put(R.id.tvValue1, 8);
        sViewsWithIds.put(R.id.tvValue2, 9);
        sViewsWithIds.put(R.id.tvValue3, 10);
        sViewsWithIds.put(R.id.tvValue4, 11);
        sViewsWithIds.put(R.id.tvValue5, 12);
        sViewsWithIds.put(R.id.tvValue6, 13);
        sViewsWithIds.put(R.id.tvValue7, 14);
        sViewsWithIds.put(R.id.tvValue8, 15);
        sViewsWithIds.put(R.id.tvValue9, 16);
        sViewsWithIds.put(R.id.tvPlusMinus, 17);
        sViewsWithIds.put(R.id.tvValue0, 18);
        sViewsWithIds.put(R.id.tvDot, 19);
        sViewsWithIds.put(R.id.ivBackspace, 20);
        sViewsWithIds.put(R.id.tvEnter, 21);
    }
    // views
    // variables
    // values
    ...
    public FreqKeypadBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 22, sIncludes, sViewsWithIds));
    }
    private FreqKeypadBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
