...
public class FileRecallDialogBindingImpl extends FileRecallDialogBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tvFileNameTitle, 2);
        sViewsWithIds.put(R.id.tvFileName, 3);
        ...
        sViewsWithIds.put(R.id.tvModified, 9);
        sViewsWithIds.put(R.id.rvRecallList, 10);
        sViewsWithIds.put(R.id.tvOK, 11);
        sViewsWithIds.put(R.id.tvCancel, 12);
    }
    // views
    // variables
    // values
    ...
    public FileRecallDialogBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 13, sIncludes, sViewsWithIds));
    }
    private FileRecallDialogBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
