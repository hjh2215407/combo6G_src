...
public class ObwKeypadBindingImpl extends ObwKeypadBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tvPercent, 17);
    ...
    public ObwKeypadBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 19, sIncludes, sViewsWithIds));
    }
    private ObwKeypadBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
