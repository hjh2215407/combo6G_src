...
public class FwUpdateDialogBindingImpl extends FwUpdateDialogBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.rvUpdateFileList, 2);
        sViewsWithIds.put(R.id.tvUpdateInfo, 3);
    ...
    public FwUpdateDialogBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }
    private FwUpdateDialogBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
