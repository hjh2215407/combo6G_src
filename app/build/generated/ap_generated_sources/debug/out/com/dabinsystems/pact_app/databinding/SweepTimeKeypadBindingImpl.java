...
public class SweepTimeKeypadBindingImpl extends SweepTimeKeypadBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tvS, 4);
        sViewsWithIds.put(R.id.tvMs, 5);
        sViewsWithIds.put(R.id.tvUs, 6);
    ...
    public SweepTimeKeypadBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 21, sIncludes, sViewsWithIds));
    }
    private SweepTimeKeypadBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
