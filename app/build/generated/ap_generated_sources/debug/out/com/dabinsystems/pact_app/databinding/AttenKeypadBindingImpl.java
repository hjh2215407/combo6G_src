...
public class AttenKeypadBindingImpl extends AttenKeypadBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tvdB, 15);
        sViewsWithIds.put(R.id.ivBackspace, 16);
        sViewsWithIds.put(R.id.tvEnter, 17);
    }
    // views
    // variables
    // values
    ...
    public AttenKeypadBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 18, sIncludes, sViewsWithIds));
    }
    private AttenKeypadBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
