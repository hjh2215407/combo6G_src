...
public class Nr5gCenterFreqKeypad extends CustomBaseDialog {
    ...
    public Nr5gCenterFreqKeypad(MainActivity activity, ActivityMainBinding binding) {
    ...
    private void clickEnter() {
        ...
        try {
            if (mKeypadBinding.tvView.getText().length() == 0) {
                ...
                DataHandler.getInstance().getNrData().getFreqData().setCenterFreq(val);
