...
public class FreqRangeTableStopFreqKeypad extends CustomBaseDialog {
    ...
    public FreqRangeTableStopFreqKeypad(MainActivity activity, ActivityMainBinding binding) {
