...
public class SaStartFreqKeypad extends CustomBaseDialog {
    ...
    public SaStartFreqKeypad(MainActivity activity, ActivityMainBinding binding) {
    ...
    private void clickEnter() {
        ...
        try {
            ...
            if (mKeypadBinding.tvView.getText().length() == 0) {
                ...
                InitActivity.logMsg("SaStartFreqKeypad", "val : " + val);
                SaDataHandler.getInstance().getConfigData().getFrequencyData().setStartFreq(val);
