...
public class SweepKeypadDialog extends CustomBaseDialog {
    ...
    public SweepKeypadDialog(MainActivity activity, ActivityMainBinding binding) {
    ...
    private void clickS() {
        ...
        if(isValue()) {
            long val = (long)(Double.parseDouble(mKeypadBinding.tvView.getText().toString()) * Math.pow(10, 6));
            SaDataHandler.getInstance().getConfigData().getSweepTimeData().setSweepTime(val);
    ...
    private void clickMs() {
        ...
        if(isValue()) {
            long val = (long)(Double.parseDouble(mKeypadBinding.tvView.getText().toString()) * Math.pow(10, 3));
            SaDataHandler.getInstance().getConfigData().getSweepTimeData().setSweepTime(val);
...
//                        (float)SaDataHandler.getInstance().getConfigData().getSweepTimeData().getSweepTimeToMs()
//                );
    ...
    private void clickUs() {
        ...
        if(isValue()) {
            long val = (long)Double.parseDouble(mKeypadBinding.tvView.getText().toString());
