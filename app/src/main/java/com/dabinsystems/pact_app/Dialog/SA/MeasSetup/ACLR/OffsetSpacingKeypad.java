...
public class OffsetSpacingKeypad extends CustomBaseDialog {
    ...
    public OffsetSpacingKeypad(MainActivity activity, ActivityMainBinding binding) {
        ...
        try {
            ...
            if (mKeypadBinding.tvView.getText().length() == 0) {
                ...
                SaDataHandler
                        ...
                        .getOffsetSetupData()
                        .setOffsetSpacing(val);

                SaDataHandler.getInstance().getConfigData().calSpanForAclr();

                ViewHandler.getInstance().getOffsetSetupView().update();
