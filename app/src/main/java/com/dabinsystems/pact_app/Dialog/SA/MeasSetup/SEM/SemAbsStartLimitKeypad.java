...
public class SemAbsStartLimitKeypad extends CustomBaseDialog {
    ...
    public SemAbsStartLimitKeypad(MainActivity activity, ActivityMainBinding binding) {
