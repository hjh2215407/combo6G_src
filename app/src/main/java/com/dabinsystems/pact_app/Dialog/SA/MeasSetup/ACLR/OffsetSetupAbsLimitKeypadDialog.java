...
public class OffsetSetupAbsLimitKeypadDialog extends CustomBaseDialog {
    ...
    public OffsetSetupAbsLimitKeypadDialog(MainActivity activity, ActivityMainBinding binding) {
