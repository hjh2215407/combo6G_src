...
public class SweptAvgHoldKeypadDialog extends CustomBaseDialog {
    ...
    public SweptAvgHoldKeypadDialog(MainActivity activity, ActivityMainBinding binding) {
    ...
    private void clickEnter() {
        ...
        try {
            ...
            SaDataHandler.getInstance().getSweptSaConfigData().getSweptSaMeasSetupData().setAvgHold(val);
