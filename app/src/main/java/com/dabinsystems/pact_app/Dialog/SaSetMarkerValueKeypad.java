...
public class SaSetMarkerValueKeypad extends CustomBaseDialog {
    ...
    public SaSetMarkerValueKeypad(MainActivity activity, ActivityMainBinding binding) {
    ...
    private void viewSetting() {
        ...
        if(type == MeasureType.MEASURE_TYPE.TRANSMIT_MASK) {
            ...
            mKeypadBinding.tvHz.setText(mActivity.getResources().getString(R.string.ns_unit));
            mKeypadBinding.tvKhz.setText(mActivity.getResources().getString(R.string.us_unit));
            mKeypadBinding.tvMhz.setText(mActivity.getResources().getString(R.string.ms_unit));
            mKeypadBinding.tvGhz.setText(mActivity.getResources().getString(R.string.s_unit));


        } else {

            mKeypadBinding.tvHz.setText(mActivity.getResources().getString(R.string.hz));
            mKeypadBinding.tvKhz.setText(mActivity.getResources().getString(R.string.khz_unit));
            mKeypadBinding.tvMhz.setText(mActivity.getResources().getString(R.string.mhz_unit));
            mKeypadBinding.tvGhz.setText(mActivity.getResources().getString(R.string.ghz_unit));
    ...
    public void clickEnter() {
        ...
        try {
            if (mKeypadBinding.tvView.getText().length() == 0) {
                ...
                FunctionHandler.getInstance().getMainLineChart().setMarkerFreq(val);
