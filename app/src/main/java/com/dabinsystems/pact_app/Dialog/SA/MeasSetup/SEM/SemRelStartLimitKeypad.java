...
public class SemRelStartLimitKeypad extends CustomBaseDialog {
    ...
    public SemRelStartLimitKeypad(MainActivity activity, ActivityMainBinding binding) {
        ...
        try {
            if (mKeypadBinding.tvView.getText().length() == 0) {
                ...
                SaDataHandler
                        ...
                        .getSemMeasSetupData()
                        .getEditMaskData()
                        .setRelStartLimit(val);

                ViewHandler.getInstance().getEditMaskLimitView().update();
