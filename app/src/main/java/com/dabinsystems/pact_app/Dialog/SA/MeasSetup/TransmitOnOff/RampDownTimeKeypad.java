...
public class RampDownTimeKeypad extends CustomBaseDialog {
...
//    private DefaultInputKeypadBinding mKeypadBinding;
    ...
    public RampDownTimeKeypad(MainActivity activity, ActivityMainBinding binding) {
    ...
    private void viewSetting() {
        ...
        //@@ [22.01.17] dialog unit button add
        mKeypadBinding.tvdB.setText("μs");
