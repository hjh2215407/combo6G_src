...
public class Nr5gLimitKeypad extends CustomBaseDialog {
    ...
    public Nr5gLimitKeypad(MainActivity activity, ActivityMainBinding binding) {
    ...
    private void clickEnter() {
        ...
        try {
            if (mKeypadBinding.tvView.getText().length() == 0) {
                ...
                DataHandler.getInstance().getNrData().getLimitData().setFreqOffsetValue(val);
