...
public class CarrierSpacingKeypad extends CustomBaseDialog {
    ...
    public CarrierSpacingKeypad(MainActivity activity, ActivityMainBinding binding) {
        ...
        try {
            ...
            if (mKeypadBinding.tvView.getText().length() == 0) {
                ...
                SaDataHandler
                        ...
                        .getCarrierSetupData()
                        .setCarrierSpacing(val);

                SaDataHandler.getInstance().getConfigData().calSpanForAclr();
                ViewHandler.getInstance().getCarrierSetupView().update();
