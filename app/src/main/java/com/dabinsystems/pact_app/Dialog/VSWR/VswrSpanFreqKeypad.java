...
public class VswrSpanFreqKeypad extends CustomBaseDialog {
    ...
    public VswrSpanFreqKeypad(MainActivity activity, ActivityMainBinding binding) {
    ...
    private void clickEnter() {
        ...
        mActivity.runOnUiThread(() -> {
            ...
            try {
                ...
                if (val >= VswrFrequencyData.DEFALUT_MIN_SPAN_FREQ && val <= VswrFrequencyData.DEFALUT_MAX_SPAN_FREQ) {

                    VswrDataHandler.getInstance().getConfigData().getFrequencyData().setSpan(val);
                    ...
                    Toast.makeText(mActivity, "Out of range(" + VswrFrequencyData.DEFALUT_MIN_SPAN_FREQ + "MHz ~ " + VswrFrequencyData.DEFALUT_MAX_SPAN_FREQ + "MHz)", Toast.LENGTH_SHORT).show();
