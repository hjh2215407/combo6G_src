...
public class SpuriousHighFreqKeypad extends CustomBaseDialog {
    ...
    public SpuriousHighFreqKeypad(MainActivity activity, ActivityMainBinding binding) {
    ...
    private void clickEnter() {
        ...
        try {
            ...
            InitActivity.logMsg("HighFreqKeypad", mKeypadBinding.tvView.getText().toString() + " " + value[0] + " " + value.length);
            ...
            if (mKeypadBinding.tvView.getText().length() == 0) {
                ...
                InitActivity.logMsg("HighFreqKeypad", value[0]);
...
//                FunctionHandler.getInstance().getMainLineChart().invalidate();
                ViewHandler.getInstance().getBandSetupView().update();
