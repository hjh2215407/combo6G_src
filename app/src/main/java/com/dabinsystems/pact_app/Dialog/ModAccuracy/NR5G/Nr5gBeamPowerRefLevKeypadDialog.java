...
public class Nr5gBeamPowerRefLevKeypadDialog extends CustomBaseDialog {
    ...
    public Nr5gBeamPowerRefLevKeypadDialog(MainActivity activity, ActivityMainBinding binding) {
    ...
    private void viewSetting() {
        ...
        new Handler(Looper.getMainLooper()).post(() -> {
            ...
            mKeypadBinding.tvdB.setText(mActivity.getResources().getText(R.string.dbm_unit));
    ...
    private void clickEnter() {
        ...
        try {
            if (mKeypadBinding.tvView.getText().length() == 0) {
                ...
                FunctionHandler.getInstance().getCandleChartFunc().setBeamPowerRefLev(val);
