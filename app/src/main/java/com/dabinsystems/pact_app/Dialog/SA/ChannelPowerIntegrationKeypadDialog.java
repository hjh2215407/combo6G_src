...
public class ChannelPowerIntegrationKeypadDialog extends CustomBaseDialog {
    ...
    public ChannelPowerIntegrationKeypadDialog(MainActivity activity, ActivityMainBinding binding) {
    ...
    private void addEvents() {
        ...
        mKeypadBinding.tvGhz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    Double val = Double.parseDouble(mKeypadBinding.tvView.getText().toString()) * Math.pow(10, 9);
                    InitActivity.logMsg("IntegrationVal", val + "");
    ...
    private void clickEnter() {
        ...
        try {
            ...
            if (mKeypadBinding.tvView.getText().length() == 0) {
                ...
                InitActivity.logMsg("integVal", val + "");
                SaDataHandler.getInstance().getChannelPowerConfigData().getChannelPowerMeasSetupData().setIngegBW(val);
