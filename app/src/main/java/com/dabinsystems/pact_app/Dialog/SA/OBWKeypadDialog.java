...
import com.dabinsystems.pact_app.databinding.ObwKeypadBinding;

import static com.dabinsystems.pact_app.View.DynamicView.convertDpToPixel;

public class OBWKeypadDialog extends CustomBaseDialog {

    private ObwKeypadBinding mKeypadBinding;
    ...
    public OBWKeypadDialog(MainActivity activity, ActivityMainBinding binding) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mKeypadBinding = DataBindingUtil.inflate(LayoutInflater.from(mActivity), R.layout.obw_keypad, null, false);
    ...
    private void addEvents() {
        ...
        mKeypadBinding.tvPercent.setOnClickListener(v->{
    ...
    private void clickEnter() {
        ...
        try {
            ...
            SaDataHandler.getInstance().getOccupiedBwConfigData().getOccupiedBwMeasSetupData().setOBWPower(val);
