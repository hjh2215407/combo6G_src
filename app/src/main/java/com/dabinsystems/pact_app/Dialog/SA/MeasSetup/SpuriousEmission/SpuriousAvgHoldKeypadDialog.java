...
public class SpuriousAvgHoldKeypadDialog extends CustomBaseDialog {
    ...
    public SpuriousAvgHoldKeypadDialog(MainActivity activity, ActivityMainBinding binding) {
    ...
    private void clickEnter() {
        ...
        try {
            ...
            SaDataHandler.getInstance().getSpuriousEmissionConfigData().getSpuriousEmissionData().setAvgHold(val);
            ViewHandler.getInstance().getMeasSetupSpuriousView().update();
