package com.dabinsystems.pact_app.Dialog.SA.MeasSetup.ACLR;
...
public class AclrAvgHoldKeypadDialog extends CustomBaseDialog {
    ...
    public AclrAvgHoldKeypadDialog(MainActivity activity, ActivityMainBinding binding) {
    ...
    private void clickEnter() {
        ...
        try {
            ...
            SaDataHandler.getInstance().getAclrConfigData().getAclrMeasSetupData().setAvgHold(val);
