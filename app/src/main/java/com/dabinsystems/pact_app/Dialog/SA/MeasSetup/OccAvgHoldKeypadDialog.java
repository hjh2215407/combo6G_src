...
public class OccAvgHoldKeypadDialog extends CustomBaseDialog {
    ...
    public OccAvgHoldKeypadDialog(MainActivity activity, ActivityMainBinding binding) {
    ...
    private void clickEnter() {
        ...
        try {
            ...
            SaDataHandler.getInstance().getOccupiedBwConfigData().getOccupiedBwMeasSetupData().setAvgHold(val);
