...
public class SemStopFreqKeypad extends CustomBaseDialog {
    ...
    public SemStopFreqKeypad(MainActivity activity, ActivityMainBinding binding) {
        ...
        mKeypadBinding.tvGhz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    /*mKeypadBinding.tvView.setText(
                            (Float.parseFloat(mKeypadBinding.tvView.getText().toString()) * Math.pow(10, 9))
                                    + "");*/
        ...
        mKeypadBinding.tvMhz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    /*float val = Math.round(Float.parseFloat(mKeypadBinding.tvView.getText().toString()) * Math.pow(10, 6));
                    mKeypadBinding.tvView.setText(val + "");*/
        ...
        mKeypadBinding.tvKhz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    /*float val = Math.round(Float.parseFloat(mKeypadBinding.tvView.getText().toString()) * Math.pow(10, 3));
                    mKeypadBinding.tvView.setText(val + "");*/

                    mKeypadBinding.tvView.setText((Double.parseDouble(mKeypadBinding.tvView.toString()) * Math.pow(10, 3) + ""));
                    //@@
                } catch (Exception e) {
                    e.printStackTrace();
                }
        ...
        mKeypadBinding.tvHz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    /*float val = Math.round(Float.parseFloat(mKeypadBinding.tvView.getText().toString()) * Math.pow(10, 0));
                    mKeypadBinding.tvView.setText(val + "");*/
    ...
    private void clickEnter() {
        ...
        try {
            ...
            if (mKeypadBinding.tvView.getText().length() == 0) {
                ...
                SaDataHandler.getInstance().getSemConfigData().getSemMeasSetupData().getEditMaskData().setStopFreq(val);
