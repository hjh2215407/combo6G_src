...
public class NrMinEvmKeypadDialog extends CustomBaseDialog {
    ...
    public NrMinEvmKeypadDialog(MainActivity activity, ActivityMainBinding binding) {
    ...
    private void clickEnter() {
        ...
        try {
            if (mKeypadBinding.tvView.getText().length() == 0) {
                ...
                boolean isPass = DataHandler.getInstance().getNrData().getLimitData().setMinEvm(val);
