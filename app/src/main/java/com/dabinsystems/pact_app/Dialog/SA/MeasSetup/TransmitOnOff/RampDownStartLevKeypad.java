...
public class RampDownStartLevKeypad extends CustomBaseDialog {
...
//    private DefaultInputKeypadBinding mKeypadBinding;
    ...
    public RampDownStartLevKeypad(MainActivity activity, ActivityMainBinding binding) {
        ...
        try {
            if (mKeypadBinding.tvView.getText().length() == 0) {
                ...
                SaDataHandler
                        ...
                        .setRampDownStartLev(val);

                ViewHandler.getInstance().getTransmitMeasSetupView().update();
