...
public class KssbKeypadDialog extends CustomBaseDialog {
    ...
    public KssbKeypadDialog(MainActivity activity, ActivityMainBinding binding) {
    ...
    private void clickEnter() {
        ...
        try {
            if (mKeypadBinding.tvView.getText().length() == 0) {
                ...
                DataHandler.getInstance().getNrData().getSsbInfoData().setKssb(val);
