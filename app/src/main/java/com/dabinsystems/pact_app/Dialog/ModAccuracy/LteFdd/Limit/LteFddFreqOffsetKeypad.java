package com.dabinsystems.pact_app.Dialog.ModAccuracy.LteFdd.Limit;
...
public class LteFddFreqOffsetKeypad extends CustomBaseDialog {
...
//    private DefaultInputKeypadBinding mKeypadBinding;
    ...
    public LteFddFreqOffsetKeypad(MainActivity activity, ActivityMainBinding binding) {
    ...
    private void viewSetting() {
        ...
        //@@ [22.01.17] dialog unit button add
        mKeypadBinding.tvdB.setText("ppm");
    ...
    private void clickEnter() {
        ...
        try {
            if (mKeypadBinding.tvView.getText().length() == 0) {
                ...
                DataHandler.getInstance().getLteFddData().getLimitData().setFreqOffset(val);
                ViewHandler.getInstance().getLteFddLimitView().update();
