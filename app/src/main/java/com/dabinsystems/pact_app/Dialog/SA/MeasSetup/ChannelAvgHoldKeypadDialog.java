package com.dabinsystems.pact_app.Dialog.SA.MeasSetup;
...
public class ChannelAvgHoldKeypadDialog extends CustomBaseDialog {

    private AvgHoldKeypadBinding mKeypadBinding;
    private ActivityMainBinding mMainBinding;
    private MainActivity mActivity;

    public ChannelAvgHoldKeypadDialog(MainActivity activity, ActivityMainBinding binding) {
    ...
    private void clickEnter() {
        ...
        try {
            ...
            SaDataHandler.getInstance().getChannelPowerConfigData().getChannelPowerMeasSetupData().setAvgHold(val);
