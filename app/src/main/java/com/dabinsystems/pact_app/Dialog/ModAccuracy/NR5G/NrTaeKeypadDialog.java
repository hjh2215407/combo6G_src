...
public class NrTaeKeypadDialog extends CustomBaseDialog {
    ...
    public NrTaeKeypadDialog(MainActivity activity, ActivityMainBinding binding) {
    ...
    private void clickEnter() {
        ...
        try {
            if (mKeypadBinding.tvView.getText().length() == 0) {
                ...
                boolean isPass = DataHandler.getInstance().getNrData().getLimitData().setTae(val);
