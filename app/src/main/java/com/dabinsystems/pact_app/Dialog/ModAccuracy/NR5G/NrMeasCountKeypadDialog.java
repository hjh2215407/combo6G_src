...
public class NrMeasCountKeypadDialog extends CustomBaseDialog {
    ...
    public NrMeasCountKeypadDialog(MainActivity activity, ActivityMainBinding binding) {
    ...
    private void clickEnter() {
        ...
        try {
            if (mKeypadBinding.tvView.getText().length() == 0) {
                ...
                boolean isPass = DataHandler.getInstance().getNrData().getTaeInfoData().setMeasCount(val);
