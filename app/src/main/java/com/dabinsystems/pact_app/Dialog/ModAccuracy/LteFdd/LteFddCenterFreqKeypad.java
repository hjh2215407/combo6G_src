...
public class LteFddCenterFreqKeypad extends CustomBaseDialog {
    ...
    public LteFddCenterFreqKeypad(MainActivity activity, ActivityMainBinding binding) {
    ...
    private void addEvents() {
        ...
        mKeypadBinding.tvHz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    mKeypadBinding.tvView.setText((Double.parseDouble(mKeypadBinding.tvView.getText().toString()) * Math.pow(10, 0)) + "");
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    private void clickEnter() {
        ...
        try {
            if (mKeypadBinding.tvView.getText().length() == 0) {
                ...
                DataHandler.getInstance().getLteFddData().setCenterFreq(val);
                ViewHandler.getInstance().getLteFddFrequencyView().update();

                InitActivity.logMsg("LteFddCenterFreqKeypad", val + "");
