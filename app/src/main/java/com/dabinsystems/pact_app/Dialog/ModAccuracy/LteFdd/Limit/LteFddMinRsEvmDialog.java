...
public class LteFddMinRsEvmDialog extends CustomBaseDialog {
...
//    private DefaultInputKeypadBinding mKeypadBinding;
    ...
    public LteFddMinRsEvmDialog(MainActivity activity, ActivityMainBinding binding) {
    ...
    private void clickEnter() {
        ...
        try {
            if (mKeypadBinding.tvView.getText().length() == 0) {
                ...
                DataHandler.getInstance().getLteFddData().getLimitData().setMinimumRsEvm(val);
