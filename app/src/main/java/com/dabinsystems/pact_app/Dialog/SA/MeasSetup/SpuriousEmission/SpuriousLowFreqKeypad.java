...
public class SpuriousLowFreqKeypad extends CustomBaseDialog {
    ...
    public SpuriousLowFreqKeypad(MainActivity activity, ActivityMainBinding binding) {
    ...
    private void clickEnter() {
        ...
        try {
            ...
            InitActivity.logMsg("LowFreqKeypad", mKeypadBinding.tvView.getText().toString() + " " + value[0] + " " + value.length);
            ...
            if (mKeypadBinding.tvView.getText().length() == 0) {
                ...
                InitActivity.logMsg("LowFreqKeypad", value[0]);
