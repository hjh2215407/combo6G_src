...
public class OffsetSetupRelLimitKeypadDialog extends CustomBaseDialog {
    ...
    public OffsetSetupRelLimitKeypadDialog(MainActivity activity, ActivityMainBinding binding) {
