...
public class Nr5gOffsetKeypadDialog extends CustomBaseDialog {
    ...
    public Nr5gOffsetKeypadDialog(MainActivity activity, ActivityMainBinding binding) {
    ...
    private void clickEnter() {
        ...
        try {
            if (mKeypadBinding.tvView.getText().length() == 0) {
                ...
                DataHandler.getInstance().getNrData().getAmpData().setOffset(val);
