...
public class GateDelayKeypadDialog extends CustomBaseDialog {
    ...
    public GateDelayKeypadDialog(MainActivity activity, ActivityMainBinding binding) {
    ...
    private void clickS() {
        ...
        if(isValue()) {
            ...
            SaDataHandler.getInstance().getConfigData().getSweepTimeData().getGateData().setGateDelay(val);
    ...
    private void clickMs() {
        ...
        if(isValue()) {
            ...
            //gateView 수정(추가)
            float max = (10000 / gateData.getGateNum()) - gateData.getGateLength();
            Log.e("GateDelay", "val : " + val + "ms");
            if (val > max) {
                Toast.makeText(mActivity, "Out of Range, Gate Delay should be less than " + max / 1000 + "ms", Toast.LENGTH_LONG).show();
                Log.e("GateDelay", "Gate Delay Out of Range");
                return;
            }
    ...
    private void clickUs() {
        ...
        if(isValue()) {
            ...
            //gateView 수정
            float max = (10000 / gateData.getGateNum()) - gateData.getGateLength();
            Log.e("GateDelay", "val : " + val + "μs");
            if (val > max) {
                Toast.makeText(mActivity, "Out of Range, Gate Delay should be less than " + max + "μs", Toast.LENGTH_LONG).show();
                Log.e("GateDelay", "Gate Delay Out of Range");
                return;
            }
