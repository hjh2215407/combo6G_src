...
public class FreqRangeTableAbsStartLimitKeypad extends CustomBaseDialog {
    ...
    public FreqRangeTableAbsStartLimitKeypad(MainActivity activity, ActivityMainBinding binding) {
...
//                double doubleVal = Double.parseDouble(mKeypadBinding.tvView.getText().toString());
...
//                InitActivity.logMsg("CenterFrequency", val + " " + doubleVal + " " + 0.123456789f);
                ...
                freqTableData.setAbsStartLimit(val);
