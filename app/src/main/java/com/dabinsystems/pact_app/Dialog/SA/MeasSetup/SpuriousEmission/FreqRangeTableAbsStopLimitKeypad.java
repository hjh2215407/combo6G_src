...
public class FreqRangeTableAbsStopLimitKeypad extends CustomBaseDialog {
    ...
    public FreqRangeTableAbsStopLimitKeypad(MainActivity activity, ActivityMainBinding binding) {
...
//                InitActivity.logMsg("CenterFrequency", val + " " + doubleVal + " " + 0.123456789f);
                ...
                freqTableData.setAbsStopLimit(val);
