...
public class LteFddTaeKeypadDialog extends CustomBaseDialog {
...
//    private DefaultInputKeypadBinding mKeypadBinding;
    ...
    public LteFddTaeKeypadDialog(MainActivity activity, ActivityMainBinding binding) {
    ...
    private void viewSetting() {
        ...
        //@@ [22.01.17] dialog unit button add
        mKeypadBinding.tvdB.setText("ns");
    ...
    private void clickEnter() {
        ...
        try {
            if (mKeypadBinding.tvView.getText().length() == 0) {
                ...
                DataHandler.getInstance().getLteFddData().getLimitData().setTae(val);
