...
public class SaRBWView2 extends LayoutBase {

    private LinearLayout linPrev,  lin300kHz, lin1MHz, lin3MHz;
    private DynamicView mDynamicView;


    public SaRBWView2(MainActivity activity, ActivityMainBinding binding) {
    ...
    public void initView() {
        ...
        String[] nameArr = {"300 kHz", "1 MHz", "3 MHz"};
        ArrayList<ArrayList<View>> layoutList = mDynamicView.getMultipleLayout(nameArr);

        lin300kHz = (LinearLayout)layoutList.get(0).get(0);
        lin1MHz = (LinearLayout)layoutList.get(1).get(0);
        lin3MHz = (LinearLayout)layoutList.get(2).get(0);
