...
public class NrSelectTriggerSourceView extends LayoutBase {

    private DynamicView dynamicView;

    private LinearLayout linInternal, linGps, linExt;

    public NrSelectTriggerSourceView(MainActivity activity, ActivityMainBinding binding) throws NullPointerException {
