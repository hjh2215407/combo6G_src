...
public class SelectTriggerSourceView extends LayoutBase {

    private DynamicView dynamicView;

    private LinearLayout linInternal, linGps, linExt;

    public SelectTriggerSourceView(MainActivity activity, ActivityMainBinding binding) throws NullPointerException {
