...
public class SaTraceModeView extends LayoutBase {
    ...
    public SaTraceModeView(MainActivity activity, ActivityMainBinding binding) {
    ...
    public void setUpEvents() {
        ...
        mActivity.runOnUiThread(() -> {
            ...
            linClearWite.setOnClickListener(v -> {
                ...
                SaDataHandler.getInstance().getConfigData().getTraceData().setMode(TRACE_MODE.CLEAR_WRITE);
            ...
            linAverage.setOnClickListener(v -> {
                ...
                SaDataHandler.getInstance().getConfigData().getTraceData().setMode(TRACE_MODE.AVERAGE);
                ViewHandler.getInstance().getContent().traceIconUpdate();
                ViewHandler.getInstance().getTrace().addMenu();
            ...
            linMaxHold.setOnClickListener(v -> {
                SaDataHandler.getInstance().getConfigData().getTraceData().setMode(TRACE_MODE.MAX_HOLD);
                ViewHandler.getInstance().getContent().traceIconUpdate();
                ViewHandler.getInstance().getTrace().addMenu();
            ...
            linMinHold.setOnClickListener(v -> {
                SaDataHandler.getInstance().getConfigData().getTraceData().setMode(TRACE_MODE.MIN_HOLD);
                ViewHandler.getInstance().getContent().traceIconUpdate();
                ViewHandler.getInstance().getTrace().addMenu();
