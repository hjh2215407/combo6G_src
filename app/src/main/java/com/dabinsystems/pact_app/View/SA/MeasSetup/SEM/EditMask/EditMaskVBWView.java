...
public class EditMaskVBWView extends LayoutBase {

    private LinearLayout lin1kHz, lin3kHz, lin10kHz, lin30kHz, lin100kHz, lin300kHz, lin1MHz, lin3MHz;
    private DynamicView mDynamicView;


    public EditMaskVBWView(MainActivity activity, ActivityMainBinding binding) {
    ...
    public void setUpEvents() {
        ...
        mActivity.runOnUiThread(() -> {
            ...
            SemMeasSetupData semData = SaDataHandler.getInstance().getConfigData().getSemMeasSetupData();
            ...
            lin1kHz.setOnClickListener(v->{
                ...
                //@@ [21.12.29] SEM VBW Fix
                semData.getEditMaskData().getBwData().setVBW(BWData.BAND_WIDTH.KHZ1);
                //@@
            ...
            lin3kHz.setOnClickListener(v->{
                ...
                //@@ [21.12.29] SEM VBW Fix
                semData.getEditMaskData().getBwData().setVBW(BWData.BAND_WIDTH.KHZ3);
                //@@
                ViewHandler.getInstance().getContent().update();
                //org
                /*ViewHandler.getInstance().getBW().addMenu();*/
            ...
            lin10kHz.setOnClickListener(v-> {
                ...
                //@@ [21.12.29] SEM VBW Fix
                semData.getEditMaskData().getBwData().setVBW(BWData.BAND_WIDTH.KHZ10);
                //@@
            ...
            lin30kHz.setOnClickListener(v-> {
                ...
                //@@ [21.12.29] SEM VBW Fix
                semData.getEditMaskData().getBwData().setVBW(BWData.BAND_WIDTH.KHZ30);
                //@@
            ...
            lin100kHz.setOnClickListener(v-> {
                ...
                //@@ [21.12.29] SEM VBW Fix
                semData.getEditMaskData().getBwData().setVBW(BWData.BAND_WIDTH.KHZ100);
                //@@
            ...
            lin300kHz.setOnClickListener(v->{
                ...
                //@@ [21.12.29] SEM VBW Fix
                semData.getEditMaskData().getBwData().setVBW(BWData.BAND_WIDTH.KHZ300);
                //@@
            ...
            lin1MHz.setOnClickListener(v->{
                ...
                //@@ [21.12.29] SEM VBW Fix
                semData.getEditMaskData().getBwData().setVBW(BWData.BAND_WIDTH.MHZ1);
                //@@
            ...
            lin3MHz.setOnClickListener(v->{
                ...
                //@@ [21.12.29] SEM VBW Fix
                semData.getEditMaskData().getBwData().setVBW(BWData.BAND_WIDTH.MHZ3);
                //@@
