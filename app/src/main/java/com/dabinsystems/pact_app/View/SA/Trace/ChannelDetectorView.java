...
public class ChannelDetectorView extends LayoutBase {
    ...
    public ChannelDetectorView(MainActivity activity, ActivityMainBinding binding) {
    ...
    public void setUpEvents() {
        ...
        mActivity.runOnUiThread(()->{
            ...
            linPeak.setOnClickListener(v-> {
                ...
                SaDataHandler.getInstance().getSemConfigData().getTraceData().setSemChannelDetector(DETECTOR.PEAK);
            ...
            linNegative.setOnClickListener(v-> {
                ...
                SaDataHandler.getInstance().getSemConfigData().getTraceData().setSemChannelDetector(DETECTOR.NEGATIVE);
                ViewHandler.getInstance().getContent().traceIconUpdate();
                ViewHandler.getInstance().getSemTraceView().addMenu();
            ...
            linSample.setOnClickListener(v-> {
                ...
                SaDataHandler.getInstance().getSemConfigData().getTraceData().setSemChannelDetector(DETECTOR.SAMPLE);
                ViewHandler.getInstance().getContent().traceIconUpdate();
                ViewHandler.getInstance().getSemTraceView().addMenu();
            ...
            linRMS.setOnClickListener(v->{
                ...
                SaDataHandler.getInstance().getSemConfigData().getTraceData().setSemChannelDetector(DETECTOR.RMS);
                ViewHandler.getInstance().getContent().traceIconUpdate();
                ViewHandler.getInstance().getSemTraceView().addMenu();
