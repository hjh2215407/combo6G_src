...
public class RefChannelVBWView extends LayoutBase {

    private LinearLayout lin1kHz, lin3kHz, lin10kHz, lin30kHz, lin100kHz, lin300kHz, lin1MHz, lin3MHz;
    private DynamicView mDynamicView;


    public RefChannelVBWView(MainActivity activity, ActivityMainBinding binding) {
        ...
        mActivity.runOnUiThread(() -> {
            ...
            lin10kHz.setOnClickListener(v-> {
                ...
                SaDataHandler
                        ...
                        .getRefChannelData()
                        .getBwData()
                        .setVBW(BWData.BAND_WIDTH.KHZ10);
            ...
            lin30kHz.setOnClickListener(v-> {
                ...
                SaDataHandler
                        ...
                        .getRefChannelData()
                        .getBwData()
                        .setVBW(BWData.BAND_WIDTH.KHZ30);
            ...
            lin100kHz.setOnClickListener(v-> {
                ...
                SaDataHandler
                        ...
                        .getRefChannelData()
                        .getBwData()
                        .setVBW(BWData.BAND_WIDTH.KHZ100);
            ...
            lin300kHz.setOnClickListener(v->{
                ...
                SaDataHandler
                        ...
                        .getRefChannelData()
                        .getBwData()
                        .setVBW(BWData.BAND_WIDTH.KHZ300);
