...
public class FileListAdapter extends RecyclerView.Adapter {
    ...
    public FileListAdapter(ArrayList<FileListInfoItem> fileListInfoList, FileRecallDialogBinding binding, Context context) {
...
//        holder.setIsRecyclable(false);
    ...
    public void setSelectedFile(FileListInfoItem item) {

        mSelectedFileInfo = item;
